        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('supir.dashboard')" :active="request()->routeIs('supir.dashboard')">
                        {{ __('Dashboard') }}
                    </x-nav-link>
                </div>
                ...
                <!-- Navigation Links -->
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('supir.attendances.index')" :active="request()->routeIs('supir.attendances.*')">
                        {{ __('Absensi') }}
                    </x-nav-link>
                </div>
