        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="p-4">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                    <div class="max-w-sm p-6 bg-blue-600 border border-blue-700 hover:bg-blue-900 rounded-lg shadow-sm">
                        <a href="{{ route('supir.attendances.index') }}">
                            <svg class="w-7 h-7 text-gray-800 dark:text-white mb-3" aria-hidden="true"
                    ...
                    <div class="max-w-sm p-6 bg-red-600 border border-red-700 hover:bg-red-900 rounded-lg shadow-sm ">
                        <a href="{{ route('supir.attendances.index') }}">
                            <svg class="w-7 h-7 text-gray-800 dark:text-white mb-3" aria-hidden="true"
                                xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none"
                                viewBox="0 0 24 24">
                            ...
                            <h5 class="mb-2 text-2xl font-semibold tracking-tight text-gray-900 dark:text-white">Belum
                                Berangkat
                            </h5>
                        </a>
                    </div>
                    ...
                    <div
                        class="max-w-sm p-6 bg-yellow-500 border border-yellow-500 hover:bg-yellow-700 rounded-lg shadow-sm ">
                        <a href="{{ route('supir.attendances.index') }}">
                            <svg class="w-7 h-7 text-white dark:text-white mb-3" viewBox="0 0 24 24" fill="currentColor"
                            ...
                            <h5 class="mb-2 text-2xl font-semibold tracking-tight text-gray-900 dark:text-white">Sedang
                                Perjalanan
                            </h5>
                        </a>
                    </div>
                    ...
                    <div
                        class="max-w-sm p-6 bg-green-600 border border-green-700 hover:bg-green-900 rounded-lg shadow-sm ">
                        <a href="{{ route('supir.attendances.index') }}">
                            <svg class="w-7 h-7 text-gray-800 dark:text-white mb-3" aria-hidden="true"
                                xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none"
                                viewBox="0 0 24 24">
                            ...
                            <h5 class="mb-2 text-2xl font-semibold tracking-tight text-gray-900 dark:text-white">Selesai
                            </h5>
                        </a>
                    </div>
                </div>
                ...
                <div class=" mt-4 relative overflow-x-auto shadow-md sm:rounded-lg">
                    <div class="flex justify-between items-center mb-4">
                        <h3 class="text-xl font-semibold text-gray-700 dark:text-white">Tugas Terbaru</h3>
                        <a href="{{ route('supir.attendances.index') }}" class="text-blue-600 hover:underline">Lihat
                            Semua</a>
                    </div>
